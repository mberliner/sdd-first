...
| SPEC-001 | Núcleo agnóstico + adaptadores | active | 2 | hibrido | [SPEC-001-agnostic-core.md](SPEC-001-agnostic-core.md) |
...
| SPEC-004 | Enforcement hardening (bootstrap hooks, reset post-commit, pre-commit robusto) | active | 13 | hibrido | [SPEC-004-enforcement-hardening.md](SPEC-004-enforcement-hardening.md) |
